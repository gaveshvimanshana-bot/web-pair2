      ...
      darkPairWeb.ev.on("connection.update", async (s) => {
        ...
        if (connection === "open") {
          try {
            ...
            const sid = `*Dark [The powerful WA BOT]*\n\n👉 ${string_session} 👈\n\n*This is the your Session ID, copy this id and paste into config.js file*\n\n*You can ask any question using this link*\n\n*wa.me/message/WKGLBR2PCETWD1*\n\n*You can join my whatsapp group*\n\n*https://chat.whatsapp.com/GAOhr0qNK7KEvJwbenGivZ*`;
            const mg = `🛑 *Do not share this code to anyone* 🛑`;
            const dt = await darkPairWeb.sendMessage(user_jid, {
              image: {
                url: "https://raw.githubusercontent.com/gaveshvimanshana-bot/web-pair2/refs/heads/main/file_000000007d40720896ebb93ba2a872f7.png",
              },
              caption: sid,
            });
            const msg = await darkPairWeb.sendMessage(user_jid, {
              text: string_session,
            });
            const msg1 = await darkPairWeb.sendMessage(user_jid, { text: mg });
          } catch (e) {
